...
//deixar a função global para poder alterar no console 
globalThis.setCardType = setCardType

//security code
const securityCode = document.querySelector('#security-code')
//criando o padrão com o mask 
...
const cardNumberPatter = {
    ...
    //A função dispatch vai ser execultada todas as vezes que for digitado um númro
    dispatch: function (appended, dynamicMasked) {
        //filtragem pra pegar somente numeros 
...
function updateExpirationDate(date){
    ...
    ccExtra.innerHTML = date.length === 0 ? "02/32": date
}